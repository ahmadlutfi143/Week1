        ...
        <Navigation2 />
            <div>
                <body className='border-category'>
                    <h3 className='mb-4' style={{ color: 'white'}}>List Category</h3>
                    <table class="table table-dark table-striped border-bottom">
                        <thead>
                            <tr>
                                <th className='pt-3 pb-4' scope="col">No&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</th>
                                <th className='pt-3 pb-4' scope="col">Category Name&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</th>
